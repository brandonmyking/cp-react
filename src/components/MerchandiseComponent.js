                ...
                <div className="row">
                    <div className="b-bottom mb-5 mb-md-0 col-12 col-md-4 b-right d-flex align-items-center">
                        <a href="#" className="overlay">
                            <img className="img-fluid" src="https://www.cutterspoint.com/media/static/images/cp-coffee-merch.png" alt="merchandise" />
                        </a>
                    </div>
                    <div className="col col-md-8">
                        <div className="row">
                            <div className="b-bottom mb-5 mb-md-0 col-12 col-md-6 d-flex justify-content-center">
                                <a href="#" className="overlay">
                                    <img className="max-500 mb-3 img-fluid" src="https://www.cutterspoint.com/media/dynamic/images/143_BestOfSouthSound.jpg" alt="south sound" />
                            ...
                            <div className="col-12 col-md-6 d-flex justify-content-center">
                                <a className="overlay" href="#">
                                    <img className="max-500 mb-3 img-fluid" src="https://www.cutterspoint.com/media/dynamic/images/142_IMG_0078.JPG" alt="flagship store" />
